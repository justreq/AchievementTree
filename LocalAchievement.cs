...
public abstract class LocalAchievement
{
    ...
    public void Complete()
    {
        if (!isCompleted)
        {
            Main.NewText($"Achievement complete! {friendlyName}");
            isCompleted = true;
        }
    }
}
    ...
    public LocalVanillaAchievement(string name) : base()
    {
        ...
        switch (name)
        {
            case VanillaAchievementName.TIMBER:
                AddCondition(new LocalItemPickupCondition(this, 9, 619, 2504, 620, 2503, 2260, 621, 911, 1729, 5215));
                break;
            case VanillaAchievementName.BENCHED:
                AddCondition(new LocalItemCraftCondition(this, [.. ItemID.Sets.Workbenches]));
                break;
            case VanillaAchievementName.NO_HOBO:
                break;
            case VanillaAchievementName.OBTAIN_HAMMER:
                AddCondition(new LocalItemPickupCondition(this, 2775, 2746, 5283, 3505, 654, 3517, 7, 3493, 2780, 1513, 2516, 660, 3481, 657, 922, 3511, 2785, 3499, 3487, 196, 367, 104, 797, 2320, 787, 1234, 1262, 3465, 204, 217, 1507, 3524, 3522, 3525, 3523, 4317, 1305));
                break;
            case VanillaAchievementName.OOO_SHINY:
                AddCondition(new LocalTileDestroyedCondition(this, 7, 6, 9, 8, 166, 167, 168, 169, 22, 204, 58, 107, 108, 111, 221, 222, 223, 211));
                break;
            case VanillaAchievementName.HEART_BREAKER:
                AddCondition(new LocalTileDestroyedCondition(this, 12));
                break;
            case VanillaAchievementName.HEAVY_METAL:
                AddCondition(new LocalItemPickupCondition(this, 35, 716));
                break;
            ...
            case VanillaAchievementName.EYE_ON_YOU:
                AddCondition(new LocalNPCKilledCondition(this, 4));
                break;
            case VanillaAchievementName.SMASHING_POPPET:
                break;
            case VanillaAchievementName.WORM_FODDER:
                AddCondition(new LocalNPCKilledCondition(this, 13, 14, 15));
                break;
            case VanillaAchievementName.MASTERMIND:
                AddCondition(new LocalNPCKilledCondition(this, 266));
                break;
            case VanillaAchievementName.WHERES_MY_HONEY:
                break;
            case VanillaAchievementName.STING_OPERATION:
                AddCondition(new LocalNPCKilledCondition(this, 222));
                break;
            case VanillaAchievementName.BONED:
                AddCondition(new LocalNPCKilledCondition(this, 35));
                break;
            case VanillaAchievementName.DUNGEON_HEIST:
                AddCondition(new LocalItemPickupCondition(this, 327));
            ...
            case VanillaAchievementName.MINER_FOR_FIRE:
                AddCondition(new LocalItemCraftCondition(this, 122));
                break;
            case VanillaAchievementName.STILL_HUNGRY:
                AddCondition(new LocalNPCKilledCondition(this, 113, 114));
                break;
            ...
            case VanillaAchievementName.EXTRA_SHINY:
                AddCondition(new LocalTileDestroyedCondition(this, 107, 108, 111, 221, 222, 223));
                break;
            case VanillaAchievementName.HEAD_IN_THE_CLOUDS:
                AddCondition(new LocalItemPickupCondition(this, 1133, 1331, 1307, 267, 1293, 5334, 557, 544, 556, 560, 43, 70, 3601, 5120, 4961, 4988, 2673));
                break;
            case VanillaAchievementName.LIKE_A_BOSS:
                AddCondition(new LocalItemPickupCondition(this, 1133, 1331, 1307, 267, 1293, 5334, 557, 544, 556, 560, 43, 70, 3601, 5120, 4961, 4988, 2673));
                break;
            case VanillaAchievementName.BUCKETS_OF_BOLTS:
                AddCondition(new LocalNPCKilledCondition(this, 125, 126));
                AddCondition(new LocalNPCKilledCondition(this, 127));
                AddCondition(new LocalNPCKilledCondition(this, 134));
                break;
            case VanillaAchievementName.DRAX_ATTAX:
                AddCondition(new LocalItemCraftCondition(this, 579, 990));
                break;
            case VanillaAchievementName.PHOTOSYNTHESIS:
                AddCondition(new LocalTileDestroyedCondition(this, 211));
                break;
            case VanillaAchievementName.GET_A_LIFE:
                break;
            case VanillaAchievementName.THE_GREAT_SOUTHERN_PLANTKILL:
                AddCondition(new LocalNPCKilledCondition(this, 262));
                break;
            case VanillaAchievementName.TEMPLE_RAIDER:
                break;
            case VanillaAchievementName.LIHZAHRDIAN_IDOL:
                AddCondition(new LocalNPCKilledCondition(this, 245));
                break;
            case VanillaAchievementName.ROBBING_THE_GRAVE:
                AddCondition(new LocalItemPickupCondition(this, 1513, 938, 963, 977, 1300, 1254, 1514, 679, 759, 1446, 1445, 1444, 1183, 1266, 671, 3291, 4679));
                break;
            case VanillaAchievementName.BIG_BOOTY:
                break;
            case VanillaAchievementName.FISH_OUT_OF_WATER:
                AddCondition(new LocalNPCKilledCondition(this, 370));
                break;
            case VanillaAchievementName.OBSESSIVE_DEVOTION:
                AddCondition(new LocalNPCKilledCondition(this, 439));
                break;
            case VanillaAchievementName.STAR_DESTROYER:
                AddCondition(new LocalNPCKilledCondition(this, 517));
                AddCondition(new LocalNPCKilledCondition(this, 422));
                AddCondition(new LocalNPCKilledCondition(this, 507));
                AddCondition(new LocalNPCKilledCondition(this, 493));
                break;
            case VanillaAchievementName.CHAMPION_OF_TERRARIA:
                AddCondition(new LocalNPCKilledCondition(this, 398));
                break;
            case VanillaAchievementName.BLOODBATH:
                break;
            case VanillaAchievementName.SLIPPERY_SHINOBI:
                AddCondition(new LocalNPCKilledCondition(this, 50));
                break;
            ...
            case VanillaAchievementName.GELATIN_WORLD_TOUR:
                AddCondition(new LocalNPCKilledCondition(this, -5));
                AddCondition(new LocalNPCKilledCondition(this, -6));
                AddCondition(new LocalNPCKilledCondition(this, 1));
                AddCondition(new LocalNPCKilledCondition(this, 81));
                AddCondition(new LocalNPCKilledCondition(this, 71));
                AddCondition(new LocalNPCKilledCondition(this, -3));
                AddCondition(new LocalNPCKilledCondition(this, 147));
                AddCondition(new LocalNPCKilledCondition(this, 138));
                AddCondition(new LocalNPCKilledCondition(this, -10));
                AddCondition(new LocalNPCKilledCondition(this, 50));
                AddCondition(new LocalNPCKilledCondition(this, 59));
                AddCondition(new LocalNPCKilledCondition(this, 16));
                AddCondition(new LocalNPCKilledCondition(this, -7));
                AddCondition(new LocalNPCKilledCondition(this, 244));
                AddCondition(new LocalNPCKilledCondition(this, -8));
                AddCondition(new LocalNPCKilledCondition(this, -1));
                AddCondition(new LocalNPCKilledCondition(this, -2));
                AddCondition(new LocalNPCKilledCondition(this, 184));
                AddCondition(new LocalNPCKilledCondition(this, 204));
                AddCondition(new LocalNPCKilledCondition(this, 225));
                AddCondition(new LocalNPCKilledCondition(this, -9));
                AddCondition(new LocalNPCKilledCondition(this, 141));
                AddCondition(new LocalNPCKilledCondition(this, 183));
                AddCondition(new LocalNPCKilledCondition(this, -4));
                break;
            ...
            case VanillaAchievementName.THERE_ARE_SOME_WHO_CALL_HIM:
                AddCondition(new LocalNPCKilledCondition(this, 45));
                break;
            case VanillaAchievementName.DECEIVER_OF_FOOLS:
                AddCondition(new LocalNPCKilledCondition(this, 196));
                break;
            case VanillaAchievementName.SWORD_OF_THE_HERO:
                AddCondition(new LocalItemPickupCondition(this, 757));
                break;
            ...
            case VanillaAchievementName.SICK_THROW:
                AddCondition(new LocalItemPickupCondition(this, 3389));
                break;
            ...
            case VanillaAchievementName.COMPLETELY_AWESOME:
                AddCondition(new LocalItemPickupCondition(this, 98));
                break;
            case VanillaAchievementName.TIL_DEATH:
                AddCondition(new LocalNPCKilledCondition(this, 53));
                break;
            case VanillaAchievementName.ARCHAEOLOGIST:
                AddCondition(new LocalNPCKilledCondition(this, 52));
                break;
            ...
            case VanillaAchievementName.PRISMANCER:
                AddCondition(new LocalItemPickupCondition(this, 495));
                break;
            ...
            case VanillaAchievementName.GLORIOUS_GOLDEN_POLE:
                AddCondition(new LocalItemPickupCondition(this, 2294));
                break;
            ...
            case VanillaAchievementName.DEFEAT_EMPRESS_OF_LIGHT:
                AddCondition(new LocalNPCKilledCondition(this, 636));
                break;
            case VanillaAchievementName.DEFEAT_QUEEN_SLIME:
                AddCondition(new LocalNPCKilledCondition(this, 657));
                break;
            case VanillaAchievementName.DEFEAT_DREADNAUTILUS:
                AddCondition(new LocalNPCKilledCondition(this, 618));
                break;
            case VanillaAchievementName.DEFEAT_OLD_ONES_ARMY_TIER3:
                break;
            case VanillaAchievementName.GET_ZENITH:
                AddCondition(new LocalItemPickupCondition(this, 4956));
                break;
            case VanillaAchievementName.GET_TERRASPARK_BOOTS:
                AddCondition(new LocalItemPickupCondition(this, 5000));
                break;
            ...
            case VanillaAchievementName.DEFEAT_DEERCLOPS:
                AddCondition(new LocalNPCKilledCondition(this, 668));
                break;
            case VanillaAchievementName.GET_GOLDEN_DELIGHT:
                AddCondition(new LocalNPCKilledCondition(this, 4022));
                break;
            case VanillaAchievementName.DRINK_BOTTLED_WATER_WHILE_DROWNING:
                break;
            case VanillaAchievementName.GET_CELL_PHONE:
                AddCondition(new LocalItemPickupCondition(this, 3124));
                break;
            case VanillaAchievementName.GET_ANKH_SHIELD:
                AddCondition(new LocalItemPickupCondition(this, 1613));
                break;
